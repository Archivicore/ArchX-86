...
RUN wget https://raw.githubusercontent.com/Archivicore/ArchX-86/master/Archxbotmain.py
RUN wget https://raw.githubusercontent.com/Archivicore/ArchX-86/master/requirements.txt
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
#CMD ["bash","boot_start.sh"]
CMD ["python3","Archxbotmain.py"]
