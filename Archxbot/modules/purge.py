...
from Archxbot import BOTLOG, BOTLOG_CHATID, CMD_HELP
from Archxbot.utils import errors_handler, register, Archx_on_cmd


@Archx.on(Archx_on_cmd(pattern="purge$"))
...
@Archx.on(Archx_on_cmd(pattern="purgeme"))
...
@Archx.on(Archx_on_cmd(pattern="del"))
...
@Archx.on(Archx_on_cmd(pattern="edit"))
...
@Archx.on(Archx_on_cmd(pattern="sd"))
