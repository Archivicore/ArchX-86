...
# All rights reserved.
"""
   Heroku manager for your Archxbot
"""
...
@Archx.on(Archx_on_cmd(pattern="usage$", outgoing=True))
@Archx.on(sudo_cmd(pattern="usage$", allow_sudo=True))
...
@Archx.on(Archx_on_cmd(pattern="logs$", outgoing=True))
@Archx.on(sudo_cmd(pattern="logs$", allow_sudo=True))
