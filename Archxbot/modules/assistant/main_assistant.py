...
from Archxbot.modules.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from Archxbot.modules.sql_helper.botusers_sql import add_me_in_db, his_userid
from Archxbot.modules.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("Deploy Tutorial 📺", "https://youtu.be/WGUmBUmI6zA")],
                [Button.url("Github Repo ❓", "github.com/sha-zu/Archxbot")],
            ],
        )
