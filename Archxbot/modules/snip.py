...
from Archxbot.modules.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@Archx.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
