...
if ENV:
    ...
    class Config(object):
        ...
        G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", -1001181795599))
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Archivicore/ArchX-86"
        )
        ALIVE_IMAGE = os.environ.get(
            "ALIVE_IMAGE", "https://telegra.ph/file/d85c7eefaeeea3320818f.jpg"
        )
